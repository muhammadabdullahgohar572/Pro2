...
import boost from '../../img/center/Bootstrap_logo.svg.png'
import c from '../../img/center/C_Logo.png'
import cc from '../../img/center/Csharp_Logo.png'
import java from '../../img/center/java-logo-vector-1.svg'
import posman from '../../img/center/postman-logo-0087CA0D15-seeklogo.com.png'
import  redux from '../../img/center/redux-logo-vector.svg'

import versal from '../../img/center/180x180.png'
import next from '../../img/center/image_processing20210620-5261-1izw9zf.png'
import fire from '../../img/center/mascot_firebase-logo.png'
import  phpto from '../../img/center/pngimg.com - photoshop_PNG11.png'
import  illus from '../../img/center/adobe-illustrator-circle-icon-for-web-design-free-png.webp'
import  navtive from '../../img/center/react-native.png'
...
import andhi from '../../img/chat/andhi.png'
import chat from '../../img/chat/chatgpt-logo-transparent-background-free-png.webp'
import  gamma from '../../img/chat/gamma.png'
import mic from '../../img/chat/microsoft-designer.png'
import stack   from '../../img/chat/stavk.png'
import  chatt from '../../img/chat/sup.png';
import pp from "../../img/chat/102047422.png"





import one from '../../img/chat/chat1/download (4).png'
import two from '../../img/chat/chat1/Font_Awesome_logomark_blue.svg.png'
import  three from '../../img/chat/chat1/img0059.jpg'
import four from '../../img/chat/chat1/Free-Premium-Mockups-Instant-Download-Mockups-Design-com.png'
...
export const Contact = () => {
  return (
    <>
        ...
        <section className="mb-8 sm:ml-0 ml-[10%] sm:container text-center justify-center  sm:grid sm:grid-cols-6 sm:mx-auto sm:px-[5%] ">
          ...
          <div>
            <img
              src={java}
              alt=""
              className="sm:w-[70%] w-[50%] sm:m-0 ml-[22%] mb-[10%] mt-[15%] sm:h-[90%] hover:drop-shadow-2xl hover:transition  hover:ease-in-out   hover:delay-150 hover:-translate-y-1 hover:scale-110  duration-300 text-align: center justify-content: center  align-items: center sm:ml-0 "
            />
          </div>
          <div>
            <img
        ...
        <section className="mb-8 sm:ml-0 ml-[10%] sm:container text-center justify-center  sm:grid sm:grid-cols-6 sm:mx-auto sm:px-[5%] ">
          <div>
            <img
              src={versal}
              alt="html"
              className="sm:w-[70%] w-[50%] sm:ml-0 ml-[20%] hover:drop-shadow-2xl hover:transition  hover:ease-in-out   hover:delay-150 hover:-translate-y-1 hover:scale-110  duration-300 text-align: center justify-content: center  align-items: center "
            />
          </div>
      ...
      <div className="container mx-auto mt-[10%] text-center text-2xl">
          <p>
